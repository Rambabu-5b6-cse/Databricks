...
-- MAGIC
-- MAGIC Inspect and run the code below to ingest the raw JSON file `/Volumes/dbacademy/ops/your-labuser-name/json_demo_files/lab_kafka_events.json` and create the **lab13_lab_kafka_events_raw** table.
-- MAGIC
